...
class    BigOrNot_CookieManager
{
    ...
    public function  getCookieValue($cookiename, $deleteIfInvalid = true)
    {
        ...
        {
            $data = $this->decodeCookieValue($_COOKIE[$cookiename]);
     ...
     *
     * @param string Encoded and encrypted cookie data
     * @param string Decoded and decrypted cookie data
     */
    public function decodeCookieValue($value)
    {
        $cookieValues = split(' ', $value);
